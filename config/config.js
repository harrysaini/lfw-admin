...
var setLinkCorrectly = function(files){
...
var initGlobalConfigFiles = function (config, assets) {
  ...
  //Setting  globbed js lib files
  config.files.client.libJS = getGlobbedPaths(assets.client.lib.js, 'public/');

  //Setting globbed js client files
  config.files.client.myJS  = getGlobbedPaths(assets.client.js, ['public/']);

  //Setting compiledJS path
  config.files.client.compiledJS = getGlobbedPaths(assets.client.compiledJS,['public/']);
  ...
  //css link
  config.files.client.cssLink = setLinkCorrectly(config.files.client.css);
