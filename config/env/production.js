...
module.exports = {
  ...
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI ||  'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'ec2-18-188-113-229.us-east-2.compute.amazonaws.com') + '/lfw-prod',
    options: {
      /**
